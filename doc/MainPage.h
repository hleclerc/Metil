...
<table cellpadding="2" cellspacing="1" border="0" width="95%" class="indextable" align="center">
    ...
    <tr>
        ...
        <td valign="top">
        <ul>
            <li> @subpage Debugging and @subpage UnitTesting </li>
            <li> @subpage BestPractices </li>
            <li> @subpage Quality </li>
        </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td valign="top">
            <ul>
                <li> @subpage Visualization </li>
                <li> @subpage FileFormats </li>
            </ul>
        </td>
        <td valign="top">
            <ul>
                <li> @subpage LinearAlgebra </li>
                <li> @subpage ProblemSolving </li>
                <li> @subpage FieldManipulation </li>
            </ul>
        </td>
        <td valign="top">
            <ul>
                <li> @subpage ProblemDefinition </li>
                <li> @subpage ConstitutiveLaws </li>
    ...
    <tr>
        <td valign="top">
            <ul>
                <li> @subpage LazyEvaluation </li>
                <li> @subpage SymbolicComputing </li>
                <li> @subpage CodeGeneration </li>
            </ul>
        </td>
        <td valign="top">
            <ul>
                <li> @subpage Blogs and @subpage Publications </li>
                <li> @subpage History </li>
                <li> @subpage Licenses </li>
            </ul>
        </td>
        <td valign="top">
            <ul>
                <li> @subpage Patches </li>
                <li> @subpage Reporting </li>
                <li> @subpage Credits </li>
            </ul>
        </td>
    </tr>
</table>
